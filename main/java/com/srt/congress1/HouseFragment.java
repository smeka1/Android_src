...
public class HouseFragment extends Fragment implements OnClickListener{
   ...
   // public List<legis.ResultsB> house;
    ...
    //public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
     //   return inflater.inflate(com.srt.congress1.R.layout.social_layout,null);
    //}
    ...
    class legisFetcher extends AsyncTask<String, String, String>
    {
        ...
        public static final String SERVER_URL = "http://php1.ikcpvqh2ya.us-west-2.elasticbeanstalk.com/?url1=http://104.198.0.197:8080/legislators?&per_page=all&chamber=house";
        ...
        protected void onPostExecute(String result) {
            ...
            if(house.size() >0)
            {
                ListView lv= (ListView)mGridView.findViewById(R.id.list_fruits);
