...
public class SentFragment extends Fragment implements OnClickListener
{
    ...
    class legisFetcher extends AsyncTask<String, String, String>
    {
        ...
        public static final String SERVER_URL = "http://php1.ikcpvqh2ya.us-west-2.elasticbeanstalk.com/?url1=http://104.198.0.197:8080/bills?&per_page=50&history.active=true&order=introduced_on__desc&last_version.urls.pdf__exists=true";
